        ...
        <Row between>
          <Col sm style={{ display: 'flex' }}>
            ...
            <span style={{ marginLeft: '10px' }}>
              <List horizontal floated="right">
                <List.Item>
                  Made by{' '}
                  <a href="https://keenant.com" target="_blank" rel="noopener noreferrer">
                    Keenan Thompson
                  </a>
                  <br />
                  <small>
                    Madgrades is unaffiliated with UW Madison. Courses updated <LatestTerm />.
                  </small>
                </List.Item>
              </List>
              <br />
          ...
          <Col auto style={{ textAlign: 'right' }}>
            <Label
              ...
              horizontal
              as="a"
              href={import.meta.env.VITE_MADGRADES_API || 'https://api.madgrades.com/'}
            >
              <Icon name="code" />
              API
            </Label>
            <Label color="black" horizontal as="a" href={`${commitUrl}${gitRev}`}>
